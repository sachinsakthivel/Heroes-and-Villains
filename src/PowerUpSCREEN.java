...
public class PowerUpSCREEN {
	...
	private void initialize() {
		...
		JButton btnHero1 = new JButton("Hero NO.1");
		...
		txtrHowdyYallWelcome.setBounds(253, 150, 406, 205);
